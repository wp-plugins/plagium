...
If you are doing a manual installation:
- create a folder "plagium" in the plugin directory
- copy all plagium files into the "plagium" folder
- go to the "plugin" menu in WordPress and activate the plugin named "Plagium".

Support: info@plagium.com
...
== Screenshots ==
1. post page integration with Plagium
